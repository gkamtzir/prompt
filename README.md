...
Σε αυτή τη φάση ξεκινάει το δεύτερο _loop_, που είναι υπεύθυνο για την εκτέλεση της κάθε εντολής. Καλείται η συνάρτηση _parse_arguments_, η οποία χωρίζει την εντολή που παίρνει σαν όρισμα. Τη χωρίζει στην εντολή που θα εκτελεστεί και στα ορίσματά της, ώστε τα δεδομένα αυτά να δοθούν στη συνάρτηση _execvp_. Εδώ, ελέγχεται αν η εντολή προς εκτέλεση είναι η εντολή εξόδου _quit_. Αν είναι, τότε τερματίζεται το πρόγραμμα. Η _quit_ είναι η μόνη εντολή που εκτελείται από το _parent process_ μιας και είναι «ειδικού» τύπου εντολή. Επίσης, ελέγχεται αν ο αριθμός των ορισμάτων μιας εντολής έχει υπερβεί το όριο (όμοια με πριν, μπορεί και εδώ να μεταβληθεί ο αριθμός αυτός με τον ίδιο ακριβώς τρόπο). Εάν η εντολή είναι διαφορετική της _quit_ και τα ορίσματά της εντός ορίων, τότε κάνουμε _fork_, με το _child process_ να εκτελεί την δοθείσα εντολή. Αν η εκτέλεση γίνει επιτυχώς, τότε το _child process_ τερματίζει με _status code 0_. Αν, όμως, η εντολή δεν εκτελεστεί σωστά, παραδείγματος χάρη λόγω σφάλματος στη σύνταξη, τότε τερματίζεται το _child process_ με _status code_ διάφορου του μηδενός (τυπικά έχει ορισθεί ο κωδικός 11, πρακτικά οποιοσδήποτε διάφορος του μηδενός θα ήταν δεκτός).
